...
describe "Flights" do
  describe "GET /flights as admin" do
    ...
    it "should have a flight form" do
      visit flights_path
      click_link("Add Flight")
      page.should have_link("Cancel")
      page.should have_button("Create Flight")
    end
    it "should cancel the flight form" do
      visit flights_path
      click_link("Add Flight")
      click_link("Cancel")
  ...
  describe "POST /flights as admin" do
    it "should create a flight and add it to the list of flights" do
      visit flights
      click_link("Add Flight")
      fill_in("Name", :with => "A 787")
      fill_in("Origin", :with => "SYD")
      fill_in("Desitination", :with => "LAX")
